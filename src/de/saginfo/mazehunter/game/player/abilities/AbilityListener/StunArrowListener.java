    ...
    public void received(Connection connection, Object object ) {
        if (object instanceof StunArrowResponse) {
            Gdx.app.postRunnable(() -> {
                ...
                GameScreen.GAMESCREEN_SINGLETON.game.world.entityManager.entities.add(new StunArrowProjectile(((StunArrowResponse)object).velocity, GameScreen.GAMESCREEN_SINGLETON.game.getPlayer(((StunArrowResponse)object).connectionID).position.cpy(), visual, ((StunArrowResponse)object).entityID));
