    ...
    public void received(Connection connection, Object object) {
        ...
        if(object instanceof FireballResponse) {
            Gdx.app.postRunnable(() -> {
                ...
                GameScreen.GAMESCREEN_SINGLETON.game.world.entityManager.entities.add(new FireballProjectile(((FireballResponse)object).velocity, GameScreen.GAMESCREEN_SINGLETON.game.getPlayer(((FireballResponse)object).connectionID).position.cpy(), visual, ((FireballResponse)object).entityID));
            });
            sound.play(1.0f);
